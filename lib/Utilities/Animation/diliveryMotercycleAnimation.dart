...
class DeliveryMotorCycleAnimation extends StatefulWidget {
  ...
  const DeliveryMotorCycleAnimation({
    Key? key,
    required this.width,
    required this.deliveryMotorcycleController,
    required this.locationPinController,
...
class _DeliveryMotorcycleAnimationState extends State<DeliveryMotorCycleAnimation> {
  ...
  late Animation _motorcycleAnimation;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        ...
        children: [],
        // <Widget>[_buildMotorcycle()]..addAll(_deliveryStops.map(_deliveryLocationStops)),
      ),
    );
  }
}